...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "minffun_kd", _hoc_minffun,
 "rate_kd", _hoc_rate,
 "taumfun_kd", _hoc_taumfun,
 0, 0
};
#define _f_taumfun _f_taumfun_kd
#define _f_minffun _f_minffun_kd
#define minffun minffun_kd
#define taumfun taumfun_kd
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kd C:/Users/ddopp/source/repos/CGProjectpub/modFiles/kd.mod\n");
...
double _f_minffun ( _threadargsprotocomma_ double _lv ) {
   double _lminffun;
 _lminffun = 1.0 / ( 1.0 + exp ( ( _lv + 13.3 ) / - 9.8 ) ) ;
...
double _f_taumfun ( _threadargsprotocomma_ double _lv ) {
   double _ltaumfun;
 _ltaumfun = 104.4 - 12.8 / ( 1.0 + exp ( ( _lv + 28.3 ) / - 19.2 ) ) ;
