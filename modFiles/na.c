...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "hinffun_na", _hoc_hinffun,
 "minffun_na", _hoc_minffun,
 "rate_na", _hoc_rate,
 "tauhfun_na", _hoc_tauhfun,
 "taumfun_na", _hoc_taumfun,
 0, 0
};
#define _f_tauhfun _f_tauhfun_na
#define _f_hinffun _f_hinffun_na
#define _f_taumfun _f_taumfun_na
#define _f_minffun _f_minffun_na
#define hinffun hinffun_na
#define minffun minffun_na
#define tauhfun tauhfun_na
#define taumfun taumfun_na
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na C:/Users/ddopp/source/repos/CGProjectpub/modFiles/na.mod\n");
...
double _f_minffun ( _threadargsprotocomma_ double _lv ) {
   double _lminffun;
 _lminffun = 1.0 / ( 1.0 + exp ( ( _lv + 18.5 ) / - 5.29 ) ) ;
...
double _f_hinffun ( _threadargsprotocomma_ double _lv ) {
   double _lhinffun;
 _lhinffun = 1.0 / ( 1.0 + exp ( ( _lv + 48.9 ) / 5.18 ) ) ;
