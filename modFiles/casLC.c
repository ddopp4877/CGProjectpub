...
#define nrn_init _nrn_init__casLC
#define _nrn_initial _nrn_initial__casLC
#define nrn_cur _nrn_cur__casLC
#define _nrn_current _nrn_current__casLC
#define nrn_jacob _nrn_jacob__casLC
#define nrn_state _nrn_state__casLC
#define _net_receive _net_receive__casLC 
#define rate rate__casLC 
#define states states__casLC 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_casLC", _hoc_setdata,
 "rate_casLC", _hoc_rate,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 casLC C:/Users/ddopp/source/repos/CGProjectpub/modFiles/casLC.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "casLC.mod";
static const char* nmodl_file_text = 
