...
#define nrn_init _nrn_init__kcaax
#define _nrn_initial _nrn_initial__kcaax
#define nrn_cur _nrn_cur__kcaax
#define _nrn_current _nrn_current__kcaax
#define nrn_jacob _nrn_jacob__kcaax
#define nrn_state _nrn_state__kcaax
#define _net_receive _net_receive__kcaax 
#define rate rate__kcaax 
#define states states__kcaax 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kcaax", _hoc_setdata,
 "rate_kcaax", _hoc_rate,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kcaax C:/Users/ddopp/source/repos/CGProjectpub/modFiles/ikcaax.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "ikcaax.mod";
static const char* nmodl_file_text = 
