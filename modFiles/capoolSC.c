...
#define nrn_init _nrn_init__capoolSC
#define _nrn_initial _nrn_initial__capoolSC
#define nrn_cur _nrn_cur__capoolSC
#define _nrn_current _nrn_current__capoolSC
#define nrn_jacob _nrn_jacob__capoolSC
#define nrn_state _nrn_state__capoolSC
#define _net_receive _net_receive__capoolSC 
#define states states__capoolSC 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_capoolSC", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define pi pi_capoolSC
 double pi = 3.14159;
#define w w_capoolSC
 double w = 1;
#define z z_capoolSC
 ...
 "pi_capoolSC", &pi_capoolSC,
 "w_capoolSC", &w_capoolSC,
 "z_capoolSC", &z_capoolSC,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 capoolSC C:/Users/ddopp/source/repos/CGProjectpub/modFiles/capoolSC.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "capoolSC.mod";
static const char* nmodl_file_text = 
