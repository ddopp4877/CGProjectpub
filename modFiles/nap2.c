...
#define _f_tauh _f_tauh_nap2
#define _f_hinf _f_hinf_nap2
#define _f_taum _f_taum_nap2
#define _f_minf _f_minf_nap2
#define hinf hinf_nap2
#define minf minf_nap2
#define tauh tauh_nap2
#define taum taum_nap2
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nap2 C:/Users/ddopp/source/repos/CGProjectpub/modFiles/nap2.mod\n");
...
double _f_minf ( _threadargsprotocomma_ double _lv ) {
   double _lminf;
 _lminf = 1.0 / ( 1.0 + exp ( ( _lv + 32.7 ) / - 18.81 ) ) * 1.0 / ( 1.0 + exp ( ( _lv + 35.0 ) / - 0.5 ) ) ;
...
double _f_taum ( _threadargsprotocomma_ double _lv ) {
   double _ltaum;
 _ltaum = 3.15 + 0.8464 / ( exp ( ( _lv + 0.8703 ) / - 6.108 ) ) ;
...
double _f_hinf ( _threadargsprotocomma_ double _lv ) {
   double _lhinf;
 _lhinf = 1.0 / ( 1.0 + exp ( ( _lv + 48.5 ) / 4.8 ) ) ;
...
double _f_tauh ( _threadargsprotocomma_ double _lv ) {
   double _ltauh;
 _ltauh = 666.0 - 379.0 / ( 1.0 + exp ( ( _lv + 33.6 ) / - 11.7 ) ) ;
