...
#define nrn_init _nrn_init__capoolax
#define _nrn_initial _nrn_initial__capoolax
#define nrn_cur _nrn_cur__capoolax
#define _nrn_current _nrn_current__capoolax
#define nrn_jacob _nrn_jacob__capoolax
#define nrn_state _nrn_state__capoolax
#define _net_receive _net_receive__capoolax 
#define states states__capoolax 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_capoolax", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define pi pi_capoolax
 double pi = 3.14159;
#define w w_capoolax
 double w = 1;
#define z z_capoolax
 ...
 "pi_capoolax", &pi_capoolax,
 "w_capoolax", &w_capoolax,
 "z_capoolax", &z_capoolax,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 capoolax C:/Users/ddopp/source/repos/CGProjectpub/modFiles/capoolax.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "capoolax.mod";
static const char* nmodl_file_text = 
