...
#define nrn_init _nrn_init__Exc
#define _nrn_initial _nrn_initial__Exc
#define nrn_cur _nrn_cur__Exc
#define _nrn_current _nrn_current__Exc
#define nrn_jacob _nrn_jacob__Exc
#define nrn_state _nrn_state__Exc
#define _net_receive _net_receive__Exc 
#define release release__Exc 
...
#define eta eta_Exc
#define omega omega_Exc
#define sfunc sfunc_Exc
#define unirand unirand_Exc
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Exc C:/Users/ddopp/source/repos/CGProjectpub/modFiles/Exc.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 131 in file Exc.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "Exc.mod";
static const char* nmodl_file_text = 
