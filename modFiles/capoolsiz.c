...
#define nrn_init _nrn_init__capoolsiz
#define _nrn_initial _nrn_initial__capoolsiz
#define nrn_cur _nrn_cur__capoolsiz
#define _nrn_current _nrn_current__capoolsiz
#define nrn_jacob _nrn_jacob__capoolsiz
#define nrn_state _nrn_state__capoolsiz
#define _net_receive _net_receive__capoolsiz 
#define states states__capoolsiz 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_capoolsiz", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define pi pi_capoolsiz
 double pi = 3.14159;
#define w w_capoolsiz
 double w = 1;
#define z z_capoolsiz
 double z = 2;
 ...
 "pi_capoolsiz", &pi_capoolsiz,
 "w_capoolsiz", &w_capoolsiz,
 "z_capoolsiz", &z_capoolsiz,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 capoolsiz C:/Users/ddopp/source/repos/CGProjectpub/modFiles/capoolsiz.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "capoolsiz.mod";
static const char* nmodl_file_text = 
