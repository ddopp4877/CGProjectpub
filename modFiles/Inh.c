...
#define nrn_init _nrn_init__Inh
#define _nrn_initial _nrn_initial__Inh
#define nrn_cur _nrn_cur__Inh
#define _nrn_current _nrn_current__Inh
#define nrn_jacob _nrn_jacob__Inh
#define nrn_state _nrn_state__Inh
#define _net_receive _net_receive__Inh 
#define release release__Inh 
...
#define srcid _p[0]
#define destid _p[1]
#define Cdur_ampa _p[2]
#define AlphaTmax_ampa _p[3]
#define Beta_ampa _p[4]
#define Erev_ampa _p[5]
#define gbar_ampa _p[6]
#define Cainf _p[7]
...
#define eta eta_Inh
#define omega omega_Inh
#define sfunc sfunc_Inh
#define unirand unirand_Inh
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Inh C:/Users/ddopp/source/repos/CGProjectpub/modFiles/Inh.mod\n");
...
/*CVODE*/
 static int _ode_spec1 () {_reset=0;
 {
   ...
   ICa = P0 * ( v - eca ) * sfunc ( _threadargscomma_ v ) ;
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 131 in file Inh.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
static void _initlists() {
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = &(r_ampa) - _p;  _dlist1[0] = &(Dr_ampa) - _p;
 _slist1[1] = &(capoolcon) - _p;  _dlist1[1] = &(Dcapoolcon) - _p;
_first = 0;
}

#if NMODL_TEXT
static const char* nmodl_filename = "Inh.mod";
static const char* nmodl_file_text = 
